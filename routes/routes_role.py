...
def read_roles(db: Session = Depends(get_db)):
    ...
    roles_data = [RoleResponse.model_validate(role).model_dump() for role in roles]
    return success_response(data=roles_data, message="Roles retrieved successfully")
...
def read_role(role_id: str, db: Session = Depends(get_db)):
    ...
    role_data = RoleResponse.model_validate(role).model_dump()
    return success_response(data=role_data, message="Role retrieved successfully")
